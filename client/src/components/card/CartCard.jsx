    ...
    return (
        <div>
            ...
            <div className='border p-2'>
                        ...
                        <div className='flex items-center justify-between mb-2'>
                            ...
                            <div className='flex gap-2 items-center'>
                                ...
                                <div>
                                    ...
                                    <p className='text-sm text-gray-500'>{item.description?.substring(0, 20)}...</p>
                                </div>
                            </div>
                            {/* right */}
                            <div
                ...
                {/* total */}
                <div className='flex justify-between px-2 border-t mt-2'>
                    <span className='text-xl pt-0.5 '>Total</span>
                    <span className='text-l font-bold pt-1.5'>{formatPrice(getTotalPrice())} THB</span>
                </div>
                {/* button */}
                {carts.length > 0
                    ? (
                    ...
                    : (
                        <button disabled className='mt-4 bg-gray-400 text-white py-1 rounded-md w-full cursor-not-allowed'>
                            Checkout
                        </button>
                    )
                }
